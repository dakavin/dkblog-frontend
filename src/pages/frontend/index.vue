    ...
    <main class="container max-w-screen-xl mx-auto p-4">
        ...
        <div class="grid grid-cols-4 gap-6">
                            ...
                            <div class="p-5">
                                ...
                                <div class="mb-3">
                                    <span v-for="(tag,tagIndex) in article.tags" :key="tagIndex"
                                        ...
                                        rounded hover:bg-green-200 hover:text-green-900 dark:bg-green-900 dark:text-green-300">{{tag.name}}</span>
                                </div>
                                <!-- 文章标题 -->
                                <a href="#">
                    ...
                    <ul class="flex items-center -space-x-px h-10 text-base">
                        ...
                        <li v-for="(pageNo, index) in pages" :key="index">
                            <a @click="getArticles(pageNo)"
                               ...
                               :class="[pageNo == current ? 'text-blue-600 bg-blue-100 hover:bg-blue-100 hover:text-blue-700' : 'text-gray-500  hover:bg-gray-100 hover:text-gray-700']"
                            >
                                {{ index + 1 }}
                            </a>
                        </li>
            ...
            <aside class="col-span-4  md:col-span-1">
                ...
                <div
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <img class="w-15 h-15 mb-3 rounded-full shadow"
                             ...
                             alt="Bonnie image"/>
                        <!-- 博主昵称 -->
                        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">dakkk</h5>
                        <!-- 介绍语 -->
                        <span class="text-sm text-gray-500 dark:text-gray-400">一枚"单例非享元"的野生程序员！！</span>
                        <!-- 第三方平台主页跳转（如 GitHub 等） -->
                        <div class="flex justify-center mt-5 gap-2">
                            <!-- GitHub -->
                            <svg t="1715738815971" data-tooltip-target="github-tooltip-bottom"
                            ...
                            <!-- Gitee -->
                            <svg t="1715738489969" data-tooltip-target="gitee-tooltip-bottom"
                                 data-tooltip-placement="bottom" class="icon w-7 h-7" viewBox="0 0 1024 1024"
                            ...
                            <!-- Email -->
                            <svg t="1715738618829" data-tooltip-target="emial-tooltip-bottom"
                                 data-tooltip-placement="bottom" class="icon w-7 h-7" viewBox="0 0 1024 1024"
                ...
                <!-- 分类 -->
                <div
                    class="w-full p-5 mb-4 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
                    <!-- 分类标题 -->
                ...
                <div
                    ...
                    <!-- 标签列表 -->
                    <span
                        class="inline-block cursor-pointer bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded hover:bg-green-200 hover:text-green-900 dark:bg-green-900 dark:text-green-300">标签</span>
                    <span
                        class="inline-block cursor-pointer bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded hover:bg-green-200 hover:text-green-900 dark:bg-green-900 dark:text-green-300">标签</span>
                    <span
                        class="inline-block cursor-pointer bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded hover:bg-green-200 hover:text-green-900 dark:bg-green-900 dark:text-green-300">标签</span>
